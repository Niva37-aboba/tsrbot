...
async def about_company(message: types.Message):
    await message.answer(
        "ООО \"ТСР Остекление\" — опытная монтажная компания.\n"
        "Оформление по ТК РФ (по желанию), выплаты 2 раза в месяц, бесплатный медосмотр, спецодежда, инструмент, занятость круглый год.\n"
        "Основные обязанности: монтаж ПВХ и алюминия по проекту, соблюдение охраны труда."
    )
